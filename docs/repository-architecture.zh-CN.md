...
| 公开地址 | 职责 | 主要搜索意图 |
|---|---|---|
| `/crowdfunding-and-indie-games-research/` | 总报告 | 众筹经济性、商品/平台适配、独立游戏渠道价值与 90 天验证方案 |
| `/indie-game-crowdfunding-genres-and-gameplay/` | 配套深挖 | 当前游戏平台快照、类型与玩法、已发售案例、失败模式、平台路径和适配卡 |
| `/tools/research-to-html/` | 主 Skill 产品页 | 把有证据的决策问题转成双语 HTML 报告 |

两份报告不是测试产生的重复页。它们复用同一证据底座，但详细内容实行唯一归属：总报告负责经济性与渠道验证，配套报告负责游戏类型、案例、风险、平台路径、筛选器和评分卡。保留两页并双向互链，但不要把这些详细章节复制回总报告，也不要为近义关键词继续复制页面。
