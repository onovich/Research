...
- **Question:** How much revenue do these projects report, which business forms report more, whether the public evidence can establish profitable-project counts and profit amounts, and which forms suit online delivery and AI-assisted development.
...
- **At least 86 of 349 projects (24.6%) explicitly report $100K or more per month, and at least 151 (43.3%) report $30K or more.** Every rate uses 349 as the denominator. Projects without a comparable amount remain unknown, so these are conservative lower bounds.
...
“At least” matters: projects without a comparable amount remain unknown instead of being removed from the denominator. This prevents more complete disclosure from being mistaken for more common revenue.
...
The table uses Starter Story's published project counts and monthly-revenue medians for each business category; it does not regroup the 349-project main sample. These categories cover more cases and overlap, so they are used only to compare revenue scale and operating burden.

| Business form | Projects in this platform category | Reported monthly-revenue median | Main operating constraint |
|---|---:|---:|---|
| Simple apps | 241 | $20K | Narrow demand, easy imitation, retention sets the ceiling |
| No-code SaaS and apps | 314 | $30K | Lower build barrier does not remove acquisition and support |
| GPT wrappers | 148 | $30K | Model cost, imitation, and churn |
| Plugins | 19 | $30K | Host-platform rules and distribution dependence |
| Micro-SaaS | 670 | $40K | Subscription retention, channels, and ongoing support |
| Solo developers | 237 | $40K | The label does not guarantee a truly solo operation |
| Consumer iOS apps | 79 | $40K | Store fees, paid acquisition, and cohort retention |
| Productized services | 549 | $40K | Labor per dollar, utilization, and customer concentration |
| APIs | 54 | $80K | Reliability, security, documentation, and enterprise support |
| Marketplaces | 285 | $200K | Two-sided liquidity, trust, disputes, and operations |

These categories answer “what revenue scale is reported,” not “which type is easiest to make successful” or “which type produces the most profit.” Their project counts cannot be added together or compared directly with the 349-project main sample.
...
| [ChartDetector](https://www.starterstory.com/stories/i-make-50k-per-month-working-5-hours-a-week) | $43.7K in April | About $11.5K profit; 26.3% recalculated margin | TikTok acquisition, Apple fees, and ad creative |

The margins range from about 26% to 85%. The difference shows why “software revenue” does not establish profit quality: acquisition, platform fees, and ongoing operations determine how much revenue remains.
...
## 4. Which forms suit fully online and AI-assisted delivery

| Business structure | Build layer AI can accelerate | Commercial problem that remains |
|---|---|---|
| Platform workflow tool | UI, database, payments, external APIs | Platform dependence, store conversion, integration support |
| One-job generator | Narrow input-output flow, rules, or inference | Repeat use, inference cost, SEO durability |
| Mobile utility | Mobile UI, subscriptions, analytics, store integration | Paid acquisition, store fees, cohort retention |
| AI support wrapper | Data ingestion, chat UI, model and vector APIs | Model cost, answer quality, churn, support |
| API or plugin | Endpoint and host-platform integration | Reliability, security review, platform changes |
| Marketplace | Standard web and transaction components | Two-sided liquidity, trust, disputes, operations |
| Productized service | Intake, scheduling, and delivery standardization | Labor per dollar, utilization, customer concentration |
| Sensitive-document automation | Upload, extraction, conversion, billing | Security, document variance, exception handling, compliance |
...
## 5. What the public evidence cannot answer
...
| What is the chance that a new project reaches these revenues? | Not calculable; the sample centers on revenue-generating projects and lacks all failed attempts as a denominator |
...
- Founder interviews: Data Fetcher, Supergrow, ChartDetector, Formula Bot, Bank Statement Converter, Profit AI, Erly, SiteGPT, DealA, and Antropy.
- Current product sites: [Data Fetcher](https://datafetcher.com/), [Profit AI](https://tryprofit.ai/), [Formula Bot](https://www.formulabot.com/), [SiteGPT](https://sitegpt.ai/), [Bank Statement Converter](https://bankstatementconverter.com/), [Supergrow](https://www.supergrow.ai/), and [ChartDetector](https://chartdetectorai.com/).
