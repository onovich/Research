...
A practical article published by Kickstarter and written by Jellop reports planning ranges of roughly 20%–33% for manufacturing, 15% for ad management, 10% for platform/payment/pledge services, and reward prices at three to five times incremental production cost. These are industry guidance, not audited platform distributions or profit estimates. [Practical guidance](https://updates.kickstarter.com/beyond-ads-what-creators-ask-us-most-about-running-a-successful-kickstarter/)

## 3. Product patterns

| Observed product structure | Supporting mechanism | Main limit |
|---|---|---|
| Small creator/IP publishing and collectibles with an existing audience | Emotional and collector value; controlled SKU count; light cross-border fulfillment | Licensing, low-value free worldwide shipping, uncontrolled SKUs |
| Board games, TTRPGs, and cards | Long-form explanation, collectability, expansions, and add-ons raise order value | Tooling, box weight, language editions, stretch-goal creep |
| High-ticket, demonstrable design or maker tools from experienced teams | Order value can absorb acquisition cost; video shows value quickly | Certification, tooling, manufacturing, support, and first-team execution risk |
| Clear-niche lifestyle products and digital content | Visible use case and differentiation; low marginal replication for digital rewards | Commodity comparison and real development cost |
| Complex hardware and fulfillment-heavy products from first-time teams | High public volume is possible | Many certifications, firmware/apps/cloud, global support, large parcels, many SKUs, and cash-flow exposure |
...
| Platform | Position and fees | Observed category emphasis | Evidence boundary |
|---|---|---|---|
| Kickstarter | Broad creative platform; all-or-nothing; 5% plus roughly 3%–5% payment processing | Tabletop, publishing, comics, design goods, mature technology, indie games | Platform discovery and creator-owned seed demand cannot be separated in public campaign data |
| Gamefound | Tabletop ecosystem; 5% plus payment fees | Board games, TTRPGs, miniatures, gaming accessories, books and geek goods | Official eligibility excludes video games |
| BackerKit | Crowdfunding, email, and pledge management; US pricing 5% plus 2.9% + $0.30 per transaction | Repeat creators, TTRPGs, publishing, fan goods, owned lists | Its audience tools make creator-owned reach part of the observed mechanism |
| Indiegogo | Acquired by Gamefound and upgraded in 2025; 5% plus payment fees, with late pledges | Near-production technology and continued preorders | No comparable 2025/2026 public category data for digital indie games were found |
...
| Former JD crowdfunding | No reliable current campaign directory verified | No current category emphasis could be established | Historical rankings do not describe the current market |
...
## 5. Indie games: channel evidence

Current platform evidence establishes that video-game crowdfunding remains active; it does not establish that a new project will be discovered, delivered, or profitable. The evidence supports a narrower distinction:
