...
3. Define the public surface before building. Use `public-site.json` as a file allowlist, copy [Build-PublicResearchSite.ps1](assets/Build-PublicResearchSite.ps1) to `scripts/`, and adapt [public-site.example.json](assets/public-site.example.json). Include only reader pages, share images, sitemap, favicon, CSS, and runtime JavaScript. Exclude notebooks, README files, docs, skills, scripts, templates, local configuration, and hidden directories.
